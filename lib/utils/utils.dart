...
class Utils {
  //
  static bool get isArabic => LocalizeAndTranslate.getLanguageCode() == "ar";
  ...
  static setJiffyLocale() async {
    String cLocale = LocalizeAndTranslate.getLanguageCode();
    List<String> supportedLocales = Jiffy.getSupportedLocales();
    if (supportedLocales.contains(cLocale)) {
      await Jiffy.setLocale(LocalizeAndTranslate.getLanguageCode());
    } else {
